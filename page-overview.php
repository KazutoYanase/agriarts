...
<div class="over_philosophy" id="philosophy">
    ...
    <div class="txt_wrap">
        ...
        <div class="txtbox">
            ...
            <div class="main_txt mgn_btm fade">
                創業96年アグリ・アーツ（光延農園）は農業の総合会社として、農に携わるあらゆる方々と共に農業発展のお手伝いをしてきました。<br>
                <br>
            ...
            <div class="main_txt fade">
                ...
                わたしたちアグリ・アーツは創業96年、数多くのメーカーとの長年の取引実績があります。その信頼関係に基づき、アグリ・アーツは他社にはない圧倒的な品揃えがあります。その中から、それぞれのお客さまに最適なものをセレクトし、ご提案を差し上げることができることが特徴です。<br>
                <br>
        ...
        <div class="txt_wrap">
            ...
            <div class="box_txt">
                ...
                <div class="copy fade">
                    ...
                    天草の地で創業以来96年、農家さんと共に農業の発展に努めてまいりました。<br>
                    <br>
                    時代が移り変わり、平和な時代から混沌とする現在でも、「食の安全」「持続可能な農業」など、生きるために必要な食の重要性はいつの時代も変わることはありません。<br>
                    <br>
                    私たちの会社は、長年の経験や伝統的な手法を重んじながらも、農業の新たな可能性と革新を追求し、農家さんに寄り添い共に繁栄できるパートナーとして、農業業界の発展と未来を築いていける事をスタッフ一同楽しみにしています。
                </div>
                <div class="name fade">
                    代表取締役　光延 啓人
                </div>
