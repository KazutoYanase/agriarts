    ...
    <div class="sales_box">
        <div class="sales_txt">
            ...
            <div class="body_copy">
                ...
                　私たちは、農家の方々が高品質な農作物を生産できるように、最新の農業技術や研究結果、新商品や新しい栽培方法等の情報を提供することにも力を入れています。当社のスタッフは、農業に関する知識が豊富であり、お客さまのニーズに合わせた最適な農業資材を提供するために尽力しています。また、私たちはお客さまとの信頼関係を大切にし、常にお客さまの立場に立ったサービスを提供することを心がけています。私たちは、お客さまのご要望に迅速かつ正確に対応することで、お客さまの生産性向上に貢献することを目指しています。<br>
