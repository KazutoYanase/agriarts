...
<div class="top__message">
        <div class="main_txt">
                ...
                持続可能な社会を目指して<br>
                その営み中で解決していく。<br>
                そんな、お客さまに信頼されるパートナーを<br class="sp_inline">目指してまいります。
        </div>
...
<div class="top_overview">
        ...
        <div class="inner">
                ...
                <div class="copy">
                        ...
                        <div class="txt fade">
                                昭和２年の創業以来、天草を基盤として農業の発展のお手伝いをしてきたアグリ・アーツは「農業の明るい未来を創造する」をテーマに、よりお客さまに信頼されるパートナーを目指していまいります。
                        </div>
